...
const TOTAL_STEPS = 8; // intro + 6 phases + summary
...
const PHASES = [
  {
    ...
    SVG: InterphaseSVG,
    description:
      "The cell spends most of its life in interphase. During this stage, the cell grows, performs normal functions, and duplicates its DNA in preparation for division.",
    keyFacts: [
  ...
  },
  {
    ...
    SVG: ProphaseSVG,
    description:
      "Chromatin condenses into distinct chromosomes. The nuclear envelope begins to break down, and the mitotic spindle starts to form from centrioles.",
    keyFacts: [
  ...
  },
  {
    ...
    SVG: MetaphaseSVG,
    description:
      "Chromosomes align along the cell's equator (metaphase plate). Spindle fibers attach to each chromosome's centromere, ready to pull them apart.",
    keyFacts: [
  ...
  },
  {
    ...
    SVG: AnaphaseSVG,
    description:
      "Sister chromatids are pulled apart toward opposite poles of the cell. The cell elongates as spindle fibers shorten.",
    keyFacts: [
  ...
  },
  {
    ...
    SVG: TelophaseSVG,
    description:
      "Two new nuclei form at each pole as chromosomes decondense. The nuclear envelope re-forms around each set of chromosomes.",
    keyFacts: [
  ...
  },
  {
    ...
    SVG: CytokinesisSVG,
    description:
      "The cytoplasm divides, producing two genetically identical daughter cells. In animal cells, a cleavage furrow pinches the cell in two.",
    keyFacts: [
...
export default function CellDivisionExperiment() {
  ...
  const phaseIndex = step - 1; // slide 0=intro, 1-6=phases, 7=summary
  const currentPhase =
    phaseIndex >= 0 && phaseIndex < PHASES.length ? PHASES[phaseIndex] : null;
        ...
        <div className="shrink-0 bg-background border-b border-border px-4 py-2">
          ...
          <div className="max-w-5xl mx-auto flex justify-between mt-1">
            {PHASES.map((p, i) => (
              <span
                key={i}
                className={`text-[9px] font-medium transition-colors flex-1 text-center ${i === phaseIndex ? "text-emerald-600" : "text-muted-foreground/50"}`}
              >
                {p.name}
              </span>
            ))}
                ...
                <div className="flex flex-col gap-6 items-center text-center max-w-2xl mx-auto">
                  ...
                  >
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      chromosomes and divides to produce two genetically{" "}
                      <strong className="text-foreground">
                        identical daughter cells
                      </strong>
                      . It is fundamental to growth, repair, and asexual
                      reproduction.
                    </p>
                  </motion.div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Press <strong>Next</strong> or <strong>Auto</strong> to
                    watch each phase animate live.
                  </p>
                </div>
              )}
              ...
              {currentPhase && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center w-full">
                  ...
                  <div className="space-y-4">
                    <div>
                      <span
                        className={`inline-block px-2.5 py-1 rounded-full text-xs font-semibold ${currentPhase.bg} ${currentPhase.color} mb-2`}
                      >
                        {currentPhase.tag}
                      </span>
                    ...
                    <div
                      className={`rounded-2xl border ${currentPhase.border} ${currentPhase.bg} p-4 space-y-2`}
                    >
                      ...
                      {currentPhase.keyFacts.map((fact, i) => (
                        ...
                        >
                          <span
                            className={`mt-0.5 w-1.5 h-1.5 rounded-full shrink-0 ${currentPhase.color.replace("text-", "bg-")}`}
                          />
                ...
                <div className="flex flex-col gap-6 max-w-3xl mx-auto w-full">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Review all phases and their key events.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {PHASES.map((p, i) => (
                      ...
                      >
                        ...
                        <p className={`font-bold font-heading ${p.color}`}>
                          {p.name}
                        </p>
                  ...
                  <div className="p-4 rounded-2xl bg-card border border-border text-center">
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      , each with the full set of chromosomes.
                    </p>
                  </div>
                </div>
              )}
      ...
      <footer className="shrink-0 bg-background/90 backdrop-blur-xl border-t border-border px-4 py-3">
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
          ...
          {step < TOTAL_STEPS - 1 ? (
            <Button
              onClick={handleNext}
              className="gap-2 min-w-[90px] bg-emerald-600 hover:bg-emerald-700 text-white"
            >
