...
const STEPS = [
  ...
  { id: 1, label: "Destarch" },
  { id: 2, label: "Setup" },
  { id: 3, label: "Time-lapse" },
  { id: 4, label: "Boil" },
  { id: 5, label: "Ethanol" },
  { id: 6, label: "Iodine Test" },
...
const THEME = {
  ...
  dot:       "#16a34a",
  button:    "bg-green-600 hover:bg-green-700 text-white border-0",
};
...
export default function PhotosynthesisExperiment() {
  ...
  return (
    <ExperimentShell
      ...
      subject="Biology · Comparative Experiment"
      icon={Sun}
      theme={THEME}
      stages={STEPS}
      step={step}
              ...
              {[
                {
                  ...
                  color: "text-indigo-700", bg: "bg-indigo-500/8", border: "border-indigo-500/30", dot: "bg-indigo-700",
                },
                {
                  ...
                  color: "text-amber-700", bg: "bg-amber-500/8", border: "border-amber-500/30", dot: "bg-amber-600",
                },
              ].map((s) => (
