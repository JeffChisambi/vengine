...
const ALL_EXPERIMENTS = [
  ...
  },
  {
    ...
    description: "Explore series and parallel circuits. Apply Ohm's Law, watch current flow, and compare both configurations.",
    icon: Zap,
    path: "/experiment/circuits",
    accentColor: "#d97706",
  ...
  },
  {
    ...
    description: "Drag an object along an optical bench, switch between convex and concave lenses, watch rays bend dynamically, and verify 1/f = 1/dₒ + 1/dᵢ with live measurements.",
    icon: Eye,
    path: "/experiment/lens",
    accentColor: "#7c3aed",
