...
export default function AtomicStructureExperiment() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#050a14] font-body overflow-hidden text-white">
      {/* ── Header ── */}
      <header className="shrink-0 z-20 bg-[#050a14]/90 backdrop-blur-xl border-b border-white/8">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-white/40">
                  Rutherford's Discovery · Physics
                </p>
              </div>
            </div>
          </div>
      ...
      {/* ── Stage progress ── */}
      <div className="shrink-0 border-b border-white/8 px-4 py-2 bg-[#050a14]/80">
        <div className="max-w-6xl mx-auto flex items-center gap-1.5">
          {STAGES.map((s, i) => (
            ...
            >
              ...
              />
              <span
                className={`text-[9px] font-medium transition-colors hidden sm:block ${
                  i === step ? "text-cyan-400" : "text-white/25"
                }`}
              >
                {s.label}
              </span>
      ...
      {/* ── Bottom nav ── */}
      <footer className="shrink-0 bg-[#050a14]/90 backdrop-blur-xl border-t border-white/8 px-4 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
            ...
            {STAGES.map((_, i) => (
              <motion.div
                ...
                animate={{
                  width: i === step ? 20 : 8,
                  backgroundColor:
                    i === step ? "#22d3ee" : "rgba(255,255,255,0.15)",
                }}
          ...
          {step < TOTAL - 1 ? (
            <Button
              onClick={next}
              className="gap-2 min-w-[90px] bg-cyan-600 hover:bg-cyan-500 text-white border-0"
            >
